 ...
 * Use the [SpotInformationFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class SpotInformationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_spot_information, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment SpotInformationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SpotInformationFragment().apply {
